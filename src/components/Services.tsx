...
const Services = () => {
  ...
  return <section id="services" className="py-32 bg-gradient-subtle relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-1/2 w-80 h-80 bg-primary-glow/10 rounded-full blur-3xl animate-pulse" style={{
        animationDelay: '4s'
      }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-2xl text-muted-foreground max-w-2xl mx-auto animate-slide-up">Precision driven analytics for strategic growth</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          {services.map((service, index) => <Card key={service.title} className="group hover:shadow-glow transition-all duration-700 hover:scale-110 border-0 bg-card/20 backdrop-blur-md hover:bg-card/40 animate-scale-in" style={{
