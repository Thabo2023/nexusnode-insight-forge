        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center">
              <img src="/lovable-uploads/b410b5d7-b6b7-484c-ba33-cf086ec5c70a.png" alt="Nexusnode Logo" className="h-16 w-auto object-scale-down" />
            </Link>
          </div>
          ...
          <div className="md:hidden">
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-foreground hover:text-primary focus:outline-none">
