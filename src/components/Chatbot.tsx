    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          variant="hero"
          size="icon"
          className="h-14 w-14 rounded-full shadow-glow animate-glow-pulse"
        >
          {isOpen ? (
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-96 max-w-[calc(100vw-2rem)] animate-scale-in">
              ...
              <div className="p-4 border-t border-border">
                <div className="flex space-x-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 text-sm rounded-md border border-border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                  <Button
